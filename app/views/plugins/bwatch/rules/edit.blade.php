...
{{ Form::open(array('role' => 'form', 'route' => array('bwrules.update', $bwrule->id), 'method' => 'POST', 'id'=>'update')) }}
...
<div {{ $errors->has('name') ? 'class="form-group has-error"' : 'class="form-group"' }} >
    ...
    {{ Form::text('name', $bwrule->name, array('class' => 'form-control', 'placeholder' => 'Kural adını giriniz')) }}
...
<div {{ $errors->has('datamark') ? 'class="form-group has-error"' : 'class="form-group"' }} >
    ...
    {{ Form::text('datamark', $bwrule->datamark, array('class' => 'form-control', 'placeholder' => 'Güncellenen datalar için bir işaret giriniz')) }}
...
<div {{ $errors->has('fromdate') ? 'class="form-group has-error"' : 'class="form-group"' }} >
            ...
            {{ Form::select('fromdate', ['0'=>'Tüm data','1'=>'Bu günden itibaren'], $bwrule->fromdate, array('id'=>'fromdate', 'class' => 'form-control', 'placeholder' => 'Lütfen bir değer seçin')) }}
...
<div  id="sourceContainer" {{ $errors->has('project') ? 'class="form-group has-error"' : 'class="form-group"' }} >
    {{ Form::select('project', $projects, $bwrule->project_id, array('id'=>'project', 'class' => 'form-control', 'placeholder' => 'Lütfen işlem yapılacak projeyi seçin')) }}
...
<div class="center-block row">
    ...
    <div id="domainContainer" class="col-md-4" style="display: none">
        <div {{ $errors->has('domain') ? 'class="form-group has-error"' : 'class="form-group"' }} >
            ...
            {{ Form::select('domain', $domains, $bwrule->domain_id, array('id'=>'domain', 'class' => 'form-control', 'placeholder' => 'Lütfen işlem yapılacak domaini seçin')) }}
    ...
    <div id="whenContainer" class="col-md-4" style="display: none; width: 370px;">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group spinner">
                    {{ Form::text('param1', $bwrule->param1, array('class' => 'form-control input-spinner input-spinner-positive', 'placeholder' => 'Filtre adı giriniz', 'data-min' => 0, 'data-max' => 100, 'readonly')) }}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {{ Form::label('param1', 'Param (-1)', array('class' => '')) }}
                <div class="input-group spinner">
                    {{ Form::text('param2', $bwrule->param2, array('class' => 'form-control input-spinner input-spinner-negative', 'placeholder' => 'Filtre adı giriniz', 'data-min' => 0, 'data-max' => 100, 'readonly')) }}
                    <div class="input-group-btn-vertical">
                        <button class="btn btn-default btn-spinner"><i class="fa fa-caret-up"></i></button>
                        <button class="btn btn-default btn-spinner"><i class="fa fa-caret-down"></i></button>
                    </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {{ Form::label('param1', 'Param (0)', array('class' => '')) }}
                <div class="input-group spinner">
                    {{ Form::text('param3', $bwrule->param3, array('class' => 'form-control input-spinner input-spinner-neutral', 'placeholder' => 'Filtre adı giriniz', 'data-min' => 0, 'data-max' => 100, 'readonly')) }}
                    <div class="input-group-btn-vertical">
    ...
    <div class="col-md-6" id="actionContainer" style="display: none;">
        <div {{ $errors->has('action') ? 'class="form-group has-error"' : 'class="form-group"' }} >
            ...
            {{ Form::select('action', [''=>'Lütfen bir işlem seçin'] + $actions, $bwrule->action, array('id'=>'action', 'class' => 'form-control', 'placeholder' => 'Lütfen yapılacak işlemi seçin')) }}
    ...
    <div class="col-md-6" id="sentimentContainer" style="display: none;">
        <div {{ $errors->has('sentiment') ? 'class="form-group has-error"' : 'class="form-group"' }} >
            ...
            {{ Form::select('sentiment', ['1'=>'Olumlu','-1'=>'Olumsuz','0'=>'Notr'], $bwrule->sentiment, array('id'=>'sentiment', 'class' => 'form-control', 'placeholder' => 'Lütfen bir değer seçin')) }}
    ...
    <div class="col-md-6" id="deleteContainer" style="display: none;">
        <div {{ $errors->has('delete') ? 'class="form-group has-error"' : 'class="form-group"' }} >
            ...
            {{ Form::checkbox('delete', 1, $bwrule->delete, ['class' => '','id'=>'delete']) }}  Evet, onaylıyorum.
...
<div class="col-md-12">
    <hr/>
    {{ Form::submit('Güncelle', array('class' => 'btn btn-info', 'id'=>'save')); }}
    {{ HTML::linkRoute('bwatch.edit', 'İptal', array($bwatch->id), array('class' => 'btn btn-default', 'title' => 'İptal')) }}
    {{ Form::close() }}
    <input type="hidden" id="selectedQueries" value="{{$bwrule->queries}}">
        <input type="hidden" id="selectedParam1" value="{{$bwrule->param1}}">
            <input type="hidden" id="selectedParam2" value="{{$bwrule->param2}}">
                <input type="hidden" id="selectedParam3" value="{{$bwrule->param3}}">
                    <input type="hidden" id="selectedAction" value="{{$bwrule->action}}">
                        <input type="hidden" id="selectedDelete" value="{{$bwrule->delete}}">       
                            <input type="hidden" id="selectedTags" value="{{$bwrule->tags}}">
