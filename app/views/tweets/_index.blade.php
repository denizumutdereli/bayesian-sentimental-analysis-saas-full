    ...
    <%
     ...
     %>
        <div class="timeline-entry-inner">           
            ...
            <div class="wallbox timeline-label"> <!-- wallbox -->
                <div class="reteweet">
                    ...
                    <div class="reteweet-user">
                        <small><a href="/tweets/user/<%= listItem.user.screen_name %>" target="_blank" data-user-id="<%= listItem.user.id_str %>" data-user="<%= listItem.user.screen_name %>"><%= listItem.user.name %></a> tarafından retweetlendi</small>
                    </div>
                </div>
                <a class="pull-left" href="/tweets/user/<%= listItem.retweeted_status.user.screen_name %>" target="_new" style="margin-right: 5px;" data-user="<%= listItem.retweeted_status.user.screen_name %>" data-user-id="<%= listItem.retweeted_status.user.id_str %>">
                    <img class="media-object" src="<%= listItem.retweeted_status.user.profile_image_url %>" alt="..." width="40">
                </a>
                <div class="media-body">
                    <div>
                        <h5 class="media-heading">
                            <a href="/tweets/user/<%= listItem.retweeted_status.user.screen_name %>" data-user="<%= listItem.retweeted_status.user.screen_name %>" data-user-id="<%= listItem.retweeted_status.user.id_str %>">
                                <%= listItem.retweeted_status.user.name %>
                                <small>@<%= listItem.retweeted_status.user.screen_name %></small>
                            </a>
                            <a href="/tweets/user/<%= listItem.retweeted_status.user.screen_name %>" class="user-tweets" data-user="<%= listItem.retweeted_status.user.screen_name %>" data-user-id="<%= listItem.retweeted_status.user.id_str %>"><small><i class="fa fa-twitter"></i> <em>Kullanıcı tweetleri</em></small></a>
                            <a href="/tweets/user/<%= listItem.retweeted_status.user.screen_name %>" class="user-mentions" data-user="<%= listItem.retweeted_status.user.screen_name %>" data-to="<%= listItem.user.screen_name %>"><small><i class="fa fa-twitter"></i> <em>Mentions</em></small></a>
            ...
            <div class="wallbox timeline-label"> <!-- wallbox -->
                <a class="pull-left" href="/tweets/user/<%= listItem.user.screen_name %>" target="_new" style="margin-right: 5px;" data-user="<%= listItem.user.screen_name %>" data-user-id="<%= listItem.user.id_str %>">
                    <img class="media-object" src="<%= listItem.user.profile_image_url %>" alt="..." width="40">
                </a>
                <div class="media-body">
                    <h5 class="media-heading">
                        <a href="/tweets/user/<%= listItem.user.screen_name %>" data-user="<%= listItem.user.screen_name %>" data-user-id="<%= listItem.user.id_str %>">
                            <%= listItem.user.name %>
                            <small>@<%= listItem.user.screen_name %></small>
                        </a>
                        <a href="/tweets/user/<%= listItem.user.screen_name %>" class="user-tweets" data-user="<%= listItem.user.screen_name %>" data-user-id="<%= listItem.user.id_str %>"><small><i class="fa fa-twitter"></i> <em>Kullanıcı tweetleri</em></small></a>
                        <a href="/tweets/user/<%= listItem.user.screen_name %>" class="user-mentions" data-user="<%= listItem.user.screen_name %>" data-to="<%= listItem.user.screen_name %>"><small><i class="fa fa-twitter"></i> <em>Mentions</em></small></a>
