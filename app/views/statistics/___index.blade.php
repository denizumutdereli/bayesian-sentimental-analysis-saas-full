...
<div class="row">
    ...
    <div class="col-md-12">
        <h4>Yayınlanabilir, Yayınlanamaz ve Küfür İstatistikleri <small><em>(Rastgele seçilen {{ Config::get('settings.analysis.limit', 1000) }} adet data %{{ implode('-', Config::get('settings.analysis.publishable', array(60, 100))) }} arası değerler için incelenmiştir)</em></small></h4>
    </div>
